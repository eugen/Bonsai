...
\draft{Această diferență poate părea fundamentală, dar o funcție poate fi considerată generalizarea unui obiect. În secțiunile următoare vom vedea cum multe dintre principiile programării orientate obiect pot fi „simulate” cu ajutorul funcțiilor și al convențiilor de nume.
}
...
Bonsai implementează un model foarte simplu de programare bazată pe prototipuri\cite{prototype_based_programming} inspirat din JavaScript, spre deosebire de programarea bazată pe clase, utilizată in majoritatea limbajelor. Într-un model OOP bazat pe prototipuri, obiectele noi sunt create prin clonarea unor obiecte existente și moștenirea comportamentului acestora. Conceptul de „clasă” nu există, deși unele obiecte pot fi definite pentru a funcționa într-un mod similar.

\section{Crearea prototipurilor în Bonsai}

Prototipul din care moștenesc toate obiectele din bonsai este conținut în contextul rădăcină în variabila \c{object}. Acesta are standard definește variabila \c{object}, de tipul \c{BonsaiPrototypeFunction}, care reprezinta 
...
% TODO: Does this section make sense? \section{Pasarea funcțiilor Bonsai către metode .NET}
