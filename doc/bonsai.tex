...
Dicționarele reprezintă cea de-a doua structură de date imlementată în standard. Identificatorul asociat este \c{\#}. Lista elementelor cuprinse între paranteze pătrate conține pe pozițiile impare cheile, iar pe cele pare valorile. Dacă numărul de elemente este impar, atunci o excepție va fi aruncată.
...
# dictioar cu cheile numere și valorile stringuri
= .dict2 [#
  1 "luni" 
  2 "marti" 
  3 "miercuri"
...
Structurile de date pot fi de asemenea combinate cu orice adâncime, precum în următorul exemplul de cod care definește un dicționar de liste:
\begin{code}
= .listDict [#
...
Această diferență poate părea fundamentală, dar o funcție poate fi considerată generalizarea unui obiect. În secțiunile următoare vom vedea cum toate cele trei principii fundamentale OOP – moștenirea, încapsularea și polimorfismul – sunt „simulate” în Bonsai cu ajutorul funcțiilor.
